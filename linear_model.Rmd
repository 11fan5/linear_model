...
broom::tidy(fit) #formatted as table, more useful
...
skewed, non-conatanrt variance from the plot
...
what about room type across manhattan nrighborhoods?
```{r}
nyc_airbnb %>% 
  filter(
    borough == "Manhattan",
...
lets do this for all neighbourhoods
